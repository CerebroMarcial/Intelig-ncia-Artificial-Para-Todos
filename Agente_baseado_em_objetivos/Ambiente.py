...
class Ambiente():
    ...
    print('Configuração do ambiente = {}'.format(configuraçao_do_ambiente))
    def o_ambiente_esta_mudando_porque_o_agente_esta_aspirando(self,posicao):
        ...
        elif posicao == Enum_posicoes_existentes_no_ambiente_de_tarefa.C.value:
            self.configuraçao_do_ambiente[2]=Enum_estados_possiveis_do_ambiente_de_tarefa.Limpo.value
        elif posicao == Enum_posicoes_existentes_no_ambiente_de_tarefa.D.value:
