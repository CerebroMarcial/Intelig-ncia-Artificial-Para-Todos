...
def perceber_o_ambiente_de_tarefa(agente):
    ...
    elif agente.posicao_do_agente_naquele_momento == Enum_posicoes_existentes_no_ambiente_de_tarefa.C.value:
        percepcao_do_agente=ambiente.configuraçao_do_ambiente[2]
    elif agente.posicao_do_agente_naquele_momento == Enum_posicoes_existentes_no_ambiente_de_tarefa.D.value:
        percepcao_do_agente=ambiente.configuraçao_do_ambiente[3]
    elif agente.posicao_do_agente_naquele_momento == Enum_posicoes_existentes_no_ambiente_de_tarefa.E.value:
        percepcao_do_agente=ambiente.configuraçao_do_ambiente[4]
...
def agir_no_ambiente_de_tarefa(agente,ambiente,acao_decidida):
    ...
    if acao_decidida == Enum_acoes_possiveis_de_serem_tomadas.Movimentar.value:
            escolha_de_movimentacao=agente.quais_as_escolhas_de_movimentacao(agente.posicao_do_agente_naquele_momento)
